...
<Link role="button" to="/" className="text-5xl  lg:p-4  py-2 p-4 font-light no-underline lg:min-w-fit text-[#F5F5F5]">E-commerce</Link>        
    <div className="mobileMenu hidden  lg:text-5xl lg:flex  w-full  text-center font-thin lg:flex-row  flex-col lg:justify-between ">
        
<Link role="button" to="/collection/" className="py-2 lg:p-4  no-underline text-[#F5F5F5]">Collection</Link>        
   {username === 'admin' ?   (<><Controllers/> <div className="py-3 lg:p-4">
